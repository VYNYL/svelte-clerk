...
import { getEnvVariable, getDynamicPublicEnvVariables } from '../utils/getDynamicPublicEnvVariables';
import { getDynamicPrivateEnvVariables } from '../utils/getDynamicPrivateEnvVariables';
...
export const API_URL = getEnvVariable('PUBLIC_CLERK_API_URL', apiUrlFromPublishableKey(PUBLISHABLE_KEY));
